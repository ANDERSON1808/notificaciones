...
@RestController
@RequestMapping("/api/notificaciones-kafka")
public class NotificacionesKafkaResource {
    private final Logger log = LoggerFactory.getLogger(NotificacionesKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public NotificacionesKafkaResource(KafkaProperties kafkaProperties) {
