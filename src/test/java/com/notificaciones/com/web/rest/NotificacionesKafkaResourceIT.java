...
import com.notificaciones.com.config.KafkaProperties;
...
class NotificacionesKafkaResourceIT {
    ...
    void setup() {
        ...
        NotificacionesKafkaResource kafkaResource = new NotificacionesKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/notificaciones-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/notificaciones-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
